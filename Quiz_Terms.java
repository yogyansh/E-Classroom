...
public class Quiz_Terms extends JFrame implements ActionListener {
    ...
    public Quiz_Terms(String Nam, String mail, int Id) {
        setVisible(true);
        ...
        ImageIcon first = new ImageIcon(ClassLoader.getSystemResource("Classroom/icons/quizshow.jpg"));
        Image second = first.getImage().getScaledInstance(626, 626, Image.SCALE_DEFAULT);
        ImageIcon third = new ImageIcon(second);
        background = new JLabel(third);
        background.setBounds(0, 0, 626, 626);
        add(background);
        ...
        Terms1 = new JLabel("1.Quiz have a time limit so ensure that quiz is completed within");
        ...
        Terms2 = new JLabel("2.Countdown timer is shown in the quiz  navigation block ,so");
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == Enter) {
            ...
            new Quiz(Nam, mail, Id).setVisible(true);
    ...
    {
    	new Quiz_Terms("","",0).setVisible(true);
    }
}
